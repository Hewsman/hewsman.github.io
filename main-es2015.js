...
let GalleryPageComponent = class GalleryPageComponent {
    ...
    ngOnInit() {
        ...
        // AMANO DISPLAY
        this.service.imageAMano.snapshotChanges().subscribe(list => {
        ...
        this.service.imageHardysAndSons.snapshotChanges().subscribe(list => {
        ...
        // YELLOWTAIL DISPLAY
        this.service.imageYellowTail.snapshotChanges().subscribe(list => {
        ...
        // BAREFOOT DISPLAY
        this.service.imageBarefoot.snapshotChanges().subscribe(list => {
        ...
        // CONCHA TORO DISPLAY
        this.service.imageConchaToro.snapshotChanges().subscribe(list => {
        ...
        // GALLO DISPLAY
        this.service.imageGallo.snapshotChanges().subscribe(list => {
        ...
        // OTHERS DISPLAY
        this.service.imageOthers.snapshotChanges().subscribe(list => {
...
let PromptMessageComponent = class PromptMessageComponent {
    constructor(router) {
        this.router = router;
...
PromptMessageComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
];
...
let WineryPageComponent = class WineryPageComponent {
    constructor(route, router) {
        this.route = route;
        this.router = router;
        // child component
...
WineryPageComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let ImageDetailsComponent = class ImageDetailsComponent {
    // @ViewChild('yellowTailModal') public modal: ModalDirective;
    constructor(storage, service, fb) {
    ...
    ngOnInit() {
        ...
        // Hardys And Sons
        this.service.getImageHardys().subscribe(list => {
            this.winesHardys = list.map(item => {
                return Object.assign({ $key: item.key }, item.payload.val());
            });
        });
        // AMano
        this.service.getImageAMano().subscribe(list => {
            this.winesAMano = list.map(item => {
                return Object.assign({ $key: item.key }, item.payload.val());
            });
        });
        // Barefoot
        this.service.getImageBarefoot().subscribe(list => {
            this.winesBarefoot = list.map(item => {
                return Object.assign({ $key: item.key }, item.payload.val());
            });
        });
        // Concha Toro
        this.service.getImageConchaToro().subscribe(list => {
            this.winesConchaToro = list.map(item => {
                return Object.assign({ $key: item.key }, item.payload.val());
            });
        });
        // Gallo
        this.service.getImageGallo().subscribe(list => {
            this.winesGallo = list.map(item => {
                return Object.assign({ $key: item.key }, item.payload.val());
            });
        });
        // Others
        this.service.getImageOthers().subscribe(list => {
...
let ImageComponent = class ImageComponent {
    constructor(storage, service, fb, router) {
        this.storage = storage;
        this.service = service;
        this.fb = fb;
        this.router = router;
...
let UploadComponent = class UploadComponent {
    ...
    onUploadSubmit(formValue) {
        ...
        this.storage.upload(filePath, formValue.hiddenImage).snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["finalize"])(() => {
            fileRef.getDownloadURL().subscribe((url) => {
                // tslint:disable-next-line: no-string-literal
                formValue['imageUrl'] = url;
                // CONDITION TO FILE FOR EACH FOLDER
                if (formValue.category === 'A Mano') {
                    this.service.insertAMano(formValue);
                }
                if (formValue.category === 'Hardys and Sons') {
                    this.service.insertHardysAndSons(formValue);
                }
                if (formValue.category === 'YellowTail') {
                    this.service.insertYellowTail(formValue);
                }
                if (formValue.category === 'Barefoot') {
                    this.service.insertBarefoot(formValue);
                }
                if (formValue.category === 'Concha Toro') {
                    this.service.insertConchaToro(formValue);
                }
                if (formValue.category === 'Gallo') {
                    this.service.insertGallo(formValue);
                }
                if (formValue.category === 'Others') {
                    this.service.insertOthers(formValue);
                }
            });
        })).subscribe();
    }
...
let ImageService = class ImageService {
    ...
    constructor(firebase, fb, imageDelete) {
